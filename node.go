...
// #cgo LDFLAGS: -lopenzwave -Lgo/src/github.com/Troy-M/go-openzwave/openzwave
...
import (
	...
	"github.com/Troy-M/go-openzwave/NT"
)
...
func (n *node) SetNodeName(name string) {
	C.setNodeName(C.uint32(n.GetHomeId()), C.uint8(n.GetId()), C.CString(name))
}
